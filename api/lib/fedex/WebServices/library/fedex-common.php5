...
function getProperty($var){
	if($var == 'key') Return 'NdaABGRhAIWcLlXm'; 
	if($var == 'password') Return 'gaoeW7sZz4OqLjHQvowcm1KYh'; 
	if($var == 'shipaccount') Return '303918957';
	if($var == 'billaccount') Return '303918957'; 
	if($var == 'dutyaccount') Return '303918957'; 
	if($var == 'freightaccount') Return '303918957';  
	if($var == 'trackaccount') Return '303918957'; 
	if($var == 'dutiesaccount') Return '303918957';
	if($var == 'importeraccount') Return '303918957';
	if($var == 'brokeraccount') Return '303918957';
	if($var == 'distributionaccount') Return '303918957';
