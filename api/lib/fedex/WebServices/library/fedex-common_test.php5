...
function getProperty($var){
	if($var == 'key') Return 'nOoo8cF0MOwgztoh'; 
	if($var == 'password') Return 'WaiurDycAlK6OvQKvaFgGvJZy'; 
	if($var == 'shipaccount') Return '510087682';
	if($var == 'billaccount') Return '510087682'; 
	if($var == 'dutyaccount') Return '510087682'; 
	if($var == 'freightaccount') Return '510087682';  
	if($var == 'trackaccount') Return '510087682'; 
	if($var == 'dutiesaccount') Return '510087682';
	if($var == 'importeraccount') Return '510087682';
	if($var == 'brokeraccount') Return '510087682';
	if($var == 'distributionaccount') Return '510087682';
